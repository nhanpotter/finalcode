...
class SiameneLSTM:
    ...
    def train_model(self, sentences_pair, feat, scores, embedding_meta_data, model_save_directory='./'):
        ...
        lstm_layer1 = Bidirectional(LSTM(150, kernel_initializer='random_uniform', bias_initializer='zeros', activation='sigmoid', kernel_regularizer=l2(0.01), recurrent_regularizer=l2(0.01), bias_regularizer=l2(0.01)))
        lstm_layer2 = Bidirectional(LSTM(150, kernel_initializer='random_uniform', bias_initializer='zeros', activation='sigmoid', kernel_regularizer=l2(0.01), recurrent_regularizer=l2(0.01), bias_regularizer=l2(0.01)))
        ...
        feat_dense = Dense(125, activation = 'sigmoid', kernel_regularizer=l2(0.1), bias_regularizer=l2(0.1))(feat_dense)
        feat_dense = Dense(125, activation = 'sigmoid', kernel_regularizer=l2(0.1), bias_regularizer=l2(0.1))(feat_dense)
        ...
        merged = Dense(25, activation='sigmoid', kernel_regularizer=l2(0.1), bias_regularizer=l2(0.1))(merged)
